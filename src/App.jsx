                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-emerald-900/98 backdrop-blur-md border border-white/20 rounded-xl shadow-2xl z-50 overflow-hidden max-h-64 overflow-y-auto">
                    ...
                    {addressSuggestions.map((suggestion, index) => (
                      <button
                        ...
                        className="w-full text-left px-4 sm:px-6 py-5 sm:py-6 hover:bg-lime-400/20 transition-colors border-b border-white/10 last:border-0 text-white font-light text-sm sm:text-base min-h-16"
                      >
                        <div className="flex items-start gap-3 sm:gap-4">
                          <Home className="w-4 h-4 sm:w-5 sm:h-5 text-lime-400 flex-shrink-0 mt-1" />
                          <span className="break-words leading-7 block">{suggestion}</span>
                        </div>
                      </button>
                    ))}
                  </div>
